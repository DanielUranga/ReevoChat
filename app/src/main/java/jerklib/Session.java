 ...
 * Like {@link jerklib.Session#changeNick(String)} , {@link jerklib.Session#setRejoinOnKick(boolean)} , {@link jerklib.Session#getUserModes()} etc.
 * <p/>
 ...
 * of a Session with {@link jerklib.Session#setInternalEventHandler(jerklib.listeners.IRCEventListener)} and
 * {@link jerklib.Session#setInternalParser(jerklib.parsers.InternalEventParser)}.
 * <p/>
 ...
 * @see ConnectionManager#requestConnection(String, int, jerklib.Profile)
 */
public class Session extends RequestGenerator {
     ...
     * @see jerklib.parsers.InternalEventParser
     * @see jerklib.parsers.DefaultInternalEventParser
     * @see jerklib.parsers.CommandParser
     */
     ...
     * @param channel
     * @param msg
     * @see jerklib.Channel#say(String)
     */
