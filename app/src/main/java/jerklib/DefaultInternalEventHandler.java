...
import static jerklib.events.IRCEvent.Type.CONNECT_COMPLETE;
import static jerklib.events.IRCEvent.Type.JOIN;
import static jerklib.events.IRCEvent.Type.JOIN_COMPLETE;
import static jerklib.events.IRCEvent.Type.KICK_EVENT;
import static jerklib.events.IRCEvent.Type.MODE_EVENT;
import static jerklib.events.IRCEvent.Type.NICK_CHANGE;
import static jerklib.events.IRCEvent.Type.NICK_IN_USE;
import static jerklib.events.IRCEvent.Type.PART;
import static jerklib.events.IRCEvent.Type.QUIT;
 ...
 *
 * @author mohadib
 * @see jerklib.DefaultInternalEventHandler#addEventHandler(jerklib.events.IRCEvent.Type, jerklib.listeners.IRCEventListener)
 * @see jerklib.DefaultInternalEventHandler#removeEventHandler(jerklib.events.IRCEvent.Type)
 * @see jerklib.listeners.IRCEventListener
 */
