...
public class ServerInformation {
    ...
    /**
     * Get all modes of the given {@link jerklib.ServerInformation.ModeType}.
     *
     * @param type - the mode type
     * @return an array containing all modes of the given type.
     * @see jerklib.ServerInformation.ModeType
     */
    ...
    /**
     * Get the {@link jerklib.ServerInformation.ModeType} for the given mode.
     *
     * @param mode the mode
     * @return the {@link jerklib.ServerInformation.ModeType}.
     * @see jerklib.ServerInformation.ModeType
     */
